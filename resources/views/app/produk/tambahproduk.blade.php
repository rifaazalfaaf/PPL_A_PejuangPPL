					...
					<form action="/action_page.php" class="p-3">
				    	<div class="container">
						    ...
						    <div class="custom-control custom-radio custom-control-inline">
						      	<input type="radio" class="custom-control-input" id="tukang_kebun" name="tukang_kebun">
						      	<label class="custom-control-label harga" for="tukang_kebun">Tukang Kebun</label>
						    </div>
						    <div class="custom-control custom-radio custom-control-inline">
