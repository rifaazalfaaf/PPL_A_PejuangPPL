    ...
    <div class="container" style="margin-top: 70px; " align="center">   
        <div class="card" style="width:450px; border-radius: 10px;">
            <div class="card-body" align="center">
                <h4 class="card-title" style="color: #6b8a3c">Daftar Akun</h4>
                ...
                <form class="form-horizontal" method="POST" action="">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-outline-secondary col-md-12" align="center">Daftar dengan Google</button>
                            </div>
                        </div>
                    ...
                    <div class="form-group mb-0">
                        <div class="col-md-12">
                            <button type="submit" class="btn col-md-12" style="background: linear-gradient(to right, #71b70b, #689e19); color: white;"> Daftar </button> <br>
                            <p style="color:#a6c372">Sudah punya akun? <b><a href="{{url('/login')}}"  style="color: #6b8a3c">Masuk sekarang</a></b></p>
                        </div>
