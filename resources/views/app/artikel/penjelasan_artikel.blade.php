...
@section('title','Penjelasan Artikel')
...
@section('content')
	<div class="container">
		<div class="jumbotron rounded-0" style="background-image: url('img/Image19@2x.png')">
		</div>
		<div class="card container rounded-0 border border-light mb-3">
			<div class="card-title nama_toko mt-3 pl-3">
				Trik Merawat Tanaman yang Tepat Agar Tetap Subur
			</div>
			<div class="card-body deskripsi_tukang">
